...
export default function SignupPage() {
  ...
  return (
    <div className='min-h-screen flex'>
      {/* Left: Signup Form */}
      <div className='w-full max-w-lg flex flex-col justify-center px-4 py-12 bg-white'>
      ...
      {/* Right: Stats & BG */}
      <div className='flex-1 flex flex-col justify-center items-center bg-gradient-to-br from-gray-900 to-gray-700 relative'>
