  ...
  return (
    <footer className='bg-gray-900 text-gray-300 pt-12 pb-6 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto'>
        {/* Main footer content */}
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 pb-8 border-b border-gray-800'>
          {/* Brand section - spans full width on mobile, 2 cols on tablet */}
        ...
        {/* Bottom section */}
        <div className='flex flex-col sm:flex-row items-center justify-between pt-6 text-gray-500 text-xs sm:text-sm gap-4'>
